...
if uploaded_file is not None:
    ...
    if st.session_state.transcription_state == "running":
        ...
        with result_placeholder:
            ...
            # Check if word timestamps were requested *and* returned
            ...
            if word_timestamps_requested and "segments" in result and result["segments"]:
                # Check if first segment has 'words' key, indicating successful word timestamp generation
            ...
            # Provide JSON download only if timestamps were successfully generated
            if word_timestamps_requested and "segments" in result and result["segments"] and "words" in result["segments"][0]:
                with col_dl2:
